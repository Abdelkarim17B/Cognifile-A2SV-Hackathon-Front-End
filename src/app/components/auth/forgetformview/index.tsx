...
function ForgetFormView() {
  ...
  return (
    <form onSubmit={onSubmit(handleForget)} className="flex flex-col gap-6 w-full">
      ...
      <button
        type="submit"
        className={`w-full dark:bg-Gray-gradient bg-Blue-gradient dark:text-cf-dark text-white font-semibold rounded-full py-4 text-xl transition duration-300 ease-in-out transform hover:from-[#c0c0c0] hover:to-[#5e5e5e] hover:shadow-lg flex items-center justify-center ${
